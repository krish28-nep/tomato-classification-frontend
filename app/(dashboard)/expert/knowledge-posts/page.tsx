    ...
    <div className="flex flex-col gap-6 max-w-3xl mx-auto">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Manage your educational posts, disease guides, and expert recommendations.
          </p>
      ...
      {posts.length > 0 ? (
        ...
        <div className="text-center py-12">
          ...
          <h3 className="font-semibold text-foreground">No knowledge posts yet</h3>
          <p className="text-sm text-muted-foreground mt-1">Create your first expert post to get started.</p>
        </div>
      )}
    </div>
  )
